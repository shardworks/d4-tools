...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b border-stone-700 px-3">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-8 w-full rounded-md bg-transparent text-sm text-stone-200 placeholder:text-stone-500 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex h-7 cursor-default select-none items-center rounded-sm px-2 text-sm text-stone-200 data-[disabled=true]:pointer-events-none data-[selected=true]:bg-accent data-[selected=true]:text-stone-100 data-[disabled=true]:opacity-50",
      className
    )}
    {...props}
  />
